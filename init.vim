...
Plug 'neoclide/coc.nvim' " Intellisense para TypeScript
let g:coc_global_extensions = [
  \ 'coc-tsserver'
  \ ]

Plug 'morhetz/gruvbox' " Esquema de cores do Intellij
...
Plug 'vim-airline/vim-airline-themes' " Tema da barra de status
Plug 'tpope/vim-fugitive' " Ver o branch atual do Git
Plug 'terryma/vim-multiple-cursors' " Multiplos cursores - <C-n> <A-n>
Plug 'tpope/vim-commentary' " Adiciona comentários
Plug 'junegunn/fzf', { 'do': { -> fzf#install() } } " Buscador de arquivos como o ctrlp
...
colorscheme gruvbox " Define o Esquema de cores do Intellij 
set mouse=a " Habita o mouse
set nu rnu " relative line numbering

" Às vezes, o realce de sintaxe pode ficar fora de sincronia em arquivos JSX e TSX grandes. 
" Isso acontecia com muita frequência para mim, então optei por habilitar syntax sync fromstart, 
" o que força o vim a verificar novamente todo o buffer ao realçar. 
" Isso tem um custo de desempenho, especialmente para arquivos grandes. 
" É significativamente mais rápido no Neovim do que no vim.
" Prefiro habilitar isso quando entro em um buffer de JavaScript ou TypeScript e desabilitá-lo ao sair: 
